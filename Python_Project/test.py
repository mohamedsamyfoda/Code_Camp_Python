...
cv2.createTrackbar("Hue Min","TrackBars",59,179,empty)
cv2.createTrackbar("Hue Max","TrackBars",179,179,empty)
cv2.createTrackbar("Set Min","TrackBars",95,255,empty)
cv2.createTrackbar("Set Max","TrackBars",255,255,empty)
cv2.createTrackbar("Val Min","TrackBars",0,255,empty)
cv2.createTrackbar("Val Max","TrackBars",255,255,empty)
while True:
    img = cv2.imread(path)
    imgHCV = cv2.cvtColor(img,cv2.COLOR_RGB2HSV)
    ...
    imgResult = cv2.bitwise_and(img,imgHCV,mask=mask)

    #cv2.imshow("imgCar",img)
    #cv2.imshow("imgHCV",imgHCV)
